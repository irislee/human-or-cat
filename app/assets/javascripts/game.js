...
bindPictureHoverEffect = function() {
  ...
  $(".pic_container img").on('load', function() {
    ...
    var height2 = $pic_container.eq(0).find("img").height();
    $pic_container.eq(0).height(height1);
    $pic_container.eq(0).height(height2);
    $pic_container.eq(0).find(".underlay").height(height1);
    $pic_container.eq(0).find(".underlay").height(height2);
    $pic_container.eq(0).find(".underlay").css("bottom", height1);
    $pic_container.eq(0).find(".underlay").css("bottom", height2);
